...
void KlasikMaplariOyla()
{
	...
	if(StrEqual(mapName, "de_dust2", false))
	{
		...
		menu2.AddItem("Train", "Train");
		menu2.AddItem("mirage", "Mirage");
		menu2.AddItem("Nuke", "Nuke");
		menu2.AddItem("Cbble", "Cbble");
		menu2.ExitButton = false;
		menu2.DisplayVoteToAll(20);
	}
	else if(StrEqual(mapName, "de_train", false))
	{
		Menu menu2 = new Menu(Handle_VoteMenu2);
		menu2.SetTitle("[DrK # GaminG] Hangi mapı oynamak istersiniz?");
		menu2.AddItem("mirage", "Mirage");
	...
	else if(StrEqual(mapName, "de_nuke", false))
	{
		Menu menu2 = new Menu(Handle_VoteMenu2);
		menu2.SetTitle("[DrK # GaminG] Hangi mapı oynamak istersiniz?");
		menu2.AddItem("Train", "Train");
...
public int Handle_VoteMenu2(Menu menu2, MenuAction action, int param1,int param2)
{
	if (action == MenuAction_End)
	{
		...
		if (param1 == 0)
		{
			...
			else if(StrContains(secilenMap, "Train", false) != -1)
			{
				ServerCommand("mp_timelimit 0");
				ServerCommand("mp_maxrounds 0");
				ServerCommand("sm_drkmap de_train");
				PrintToChatAll(" \x02[DrK # GaminG] \x10Oylamaların sonucuna göre el sonunda\x04 Train \x10açılacaktır.");
				PrintToChatAll(" \x05DrK # GaminG , iyi oyunlar diler..");
				PrintCenterTextAll("<font color='#FF0000'>[DrK # GaminG]</font> <font color='#00FFFF'>El sonu</font>\n<font color='#00FF00'>Train</font> <font color='#00FFFF'>açılacaktır.</font>");
			}
			...
			else if(StrContains(secilenMap, "Nuke", false) != -1)
			{
				ServerCommand("mp_timelimit 0");
				ServerCommand("mp_maxrounds 0");
				ServerCommand("sm_drkmap de_nuke");
				PrintToChatAll(" \x02[DrK # GaminG] \x10Oylamaların sonucuna göre el sonunda\x04 Nuke \x10açılacaktır.");
				PrintToChatAll(" \x05DrK # GaminG , iyi oyunlar diler..");
				PrintCenterTextAll("<font color='#FF0000'>[DrK # GaminG]</font> <font color='#00FFFF'>El sonu</font>\n<font color='#00FF00'>Nuke</font> <font color='#00FFFF'>açılacaktır.</font>");
			}
			else if(StrContains(secilenMap, "Cbble", false) != -1)
			{
				...
				PrintToChatAll(" \x02[DrK # GaminG] \x10Oylamaların sonucuna göre el sonunda\x04 Cbble \x10açılacaktır.");
				PrintToChatAll(" \x05DrK # GaminG , iyi oyunlar diler..");
				PrintCenterTextAll("<font color='#FF0000'>[DrK # GaminG]</font> <font color='#00FFFF'>El sonu</font>\n<font color='#00FF00'>Cbble</font> <font color='#00FFFF'>açılacaktır.</font>");
			}
		}
		if (param1 == 1)
		{
...
void FarkliMaplariOyla()
{
	...
	decl String:mapName[64];
	GetCurrentMap(mapName, sizeof(mapName));
	if(StrEqual(mapName, "de_dust", false))
	{
		Menu menufarkli = new Menu(Handle_VoteMenuFarkli);
		menufarkli.SetTitle("[DrK # GaminG] Hangi mapı oynamak istersiniz?");
		menufarkli.AddItem("de_inferno", "Inferno");
		menufarkli.AddItem("Aztec", "Aztec");
		menufarkli.AddItem("Cache", "Cache");
		menufarkli.AddItem("Toscan", "Toscan");
	...
	else if(StrEqual(mapName, "de_inferno", false))
	{
		Menu menufarkli = new Menu(Handle_VoteMenuFarkli);
		menufarkli.SetTitle("[DrK # GaminG] Hangi mapı oynamak istersiniz?");
		menufarkli.AddItem("de_dust", "Dust");
		menufarkli.AddItem("Aztec", "Aztec");
		menufarkli.AddItem("Cache", "Cache");
		menufarkli.AddItem("Toscan", "Toscan");
		menufarkli.ExitButton = false;
	...
	else if(StrEqual(mapName, "de_doscan", false))
	{
		Menu menufarkli = new Menu(Handle_VoteMenuFarkli);
		menufarkli.SetTitle("[DrK # GaminG] Hangi mapı oynamak istersiniz?");
		menufarkli.AddItem("de_dust", "Dust");
...
public int Handle_VoteMenuFarkli(Menu menufarkli, MenuAction action, int param1,int param2)
{
	if (action == MenuAction_End)
	{
		...
		if (param1 == 0)
		{
			...
			if(StrContains(secilenMap, "de_dust", false) != -1)
			{
				ServerCommand("mp_timelimit 0");
				ServerCommand("mp_maxrounds 0");
				ServerCommand("sm_drkmap de_dust");
				PrintToChatAll(" \x02[DrK # GaminG] \x10Oylamaların sonucuna göre el sonunda\x04 Dust \x10açılacaktır.");
				PrintToChatAll(" \x05DrK # GaminG , iyi oyunlar diler..");
				PrintCenterTextAll("<font color='#FF0000'>[DrK # GaminG]</font> <font color='#00FFFF'>El sonu</font>\n<font color='#00FF00'>Dust</font> <font color='#00FFFF'>açılacaktır.</font>");
			}
			else if(StrContains(secilenMap, "de_inferno", false) != -1)
			{
				ServerCommand("mp_timelimit 0");
				ServerCommand("mp_maxrounds 0");
			...
			else if(StrContains(secilenMap, "Aztec", false) != -1)
			{
				ServerCommand("mp_timelimit 0");
				ServerCommand("mp_maxrounds 0");
			...
			else if(StrContains(secilenMap, "Toscan", false) != -1)
			{
				ServerCommand("mp_timelimit 0");
				ServerCommand("mp_maxrounds 0");
				ServerCommand("sm_drkmap de_doscan");
				PrintToChatAll(" \x02[DrK # GaminG] \x10Oylamaların sonucuna göre el sonunda\x04 Toscan \x10açılacaktır.");
				PrintToChatAll(" \x05DrK # GaminG , iyi oyunlar diler..");
				PrintCenterTextAll("<font color='#FF0000'>[DrK # GaminG]</font> <font color='#00FFFF'>El sonu</font>\n<font color='#00FF00'>Toscan</font> <font color='#00FFFF'>açılacaktır.</font>");
			}
		}
		if (param1 == 1)
		{
