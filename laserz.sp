...
public OnPluginStart() {
	...
	//RegAdminCmd("+use", CMD_laser_p, ADMFLAG_ROOT);
	//RegAdminCmd("-use", CMD_laser_m, ADMFLAG_ROOT);
	RegAdminCmd("+lazer", CMD_laser_p, ADMFLAG_RCON);
	RegAdminCmd("-lazer", CMD_laser_m, ADMFLAG_RCON);
}
public OnMapStart() {
