...
public Action OylamaTetikleBlind(Handle timer)
{
	...
	CreateTimer(20.0, TSReklam2);
	CreateTimer(22.0, TSReklam2);
	CreateTimer(24.0, TSReklam2);
	CreateTimer(26.0, TSReklam2);
...
void KlasikMaplariOyla()
{
	...
	if(StrEqual(mapName, "de_dust2", false))
	{
		...
		menu2.AddItem("infernew", "Infernew");
		menu2.AddItem("mirage", "Mirage");
		menu2.AddItem("cache", "Cache");
		menu2.AddItem("sultan2", "Sultan2");
		menu2.ExitButton = false;
		menu2.DisplayVoteToAll(20);
	}
	else if(StrEqual(mapName, "de_infernew_v2", false))
	{
		Menu menu2 = new Menu(Handle_VoteMenu2);
		menu2.SetTitle("[DrK # GaminG] Hangi mapı oynamak istersiniz?");
		menu2.AddItem("mirage", "Mirage");
	...
	else if(StrEqual(mapName, "de_sultan2", false))
	{
		Menu menu2 = new Menu(Handle_VoteMenu2);
		menu2.SetTitle("[DrK # GaminG] Hangi mapı oynamak istersiniz?");
		menu2.AddItem("infernew", "Infernew");
...
public int Handle_VoteMenu2(Menu menu2, MenuAction action, int param1,int param2)
{
	if (action == MenuAction_End)
	{
		...
		if (param1 == 0)
		{
			...
			else if(StrContains(secilenMap, "infernew", false) != -1)
			{
				ServerCommand("mp_timelimit 0");
				ServerCommand("mp_maxrounds 0");
				ServerCommand("sm_drkmap de_infernew_v2");
				PrintToChatAll(" \x02[DrK # GaminG] \x10Oylamaların sonucuna göre el sonunda\x04 Infernew \x10açılacaktır.");
				PrintToChatAll(" \x05DrK # GaminG , iyi oyunlar diler..");
				PrintCenterTextAll("<font color='#FF0000'>[DrK # GaminG]</font> <font color='#00FFFF'>El sonu</font>\n<font color='#00FF00'>Infernew</font> <font color='#00FFFF'>açılacaktır.</font>");
			}
			...
			else if(StrContains(secilenMap, "sultan2", false) != -1)
			{
				ServerCommand("mp_timelimit 0");
				ServerCommand("mp_maxrounds 0");
				ServerCommand("sm_drkmap de_sultan2");
				PrintToChatAll(" \x02[DrK # GaminG] \x10Oylamaların sonucuna göre el sonunda\x04 Sultan2 \x10açılacaktır.");
				PrintToChatAll(" \x05DrK # GaminG , iyi oyunlar diler..");
				PrintCenterTextAll("<font color='#FF0000'>[DrK # GaminG]</font> <font color='#00FFFF'>El sonu</font>\n<font color='#00FF00'>Sultan2</font> <font color='#00FFFF'>açılacaktır.</font>");
			}
		}
		if (param1 == 1)
		{
...
void FarkliMaplariOyla()
{
	...
	else if(StrEqual(mapName, "cs_italy", false))
	{
		Menu menufarkli = new Menu(Handle_VoteMenuFarkli);
		menufarkli.SetTitle("[DrK # GaminG] Hangi mapı oynamak istersiniz?");
		menufarkli.AddItem("cs_downtown", "Downtown");
...
public int Handle_VoteMenuFarkli(Menu menufarkli, MenuAction action, int param1,int param2)
{
	if (action == MenuAction_End)
	{
		...
		if (param1 == 0)
		{
			...
			else if(StrContains(secilenMap, "de_dust", false) != -1)
			{
				ServerCommand("mp_timelimit 0");
				ServerCommand("mp_maxrounds 0");
				ServerCommand("sm_drkmap de_dust");
				PrintToChatAll(" \x02[DrK # GaminG] \x10Oylamaların sonucuna göre el sonunda\x04 Dust 1 \x10açılacaktır.");
				PrintToChatAll(" \x05DrK # GaminG , iyi oyunlar diler..");
				PrintCenterTextAll("<font color='#FF0000'>[DrK # GaminG]</font> <font color='#00FFFF'>El sonu</font>\n<font color='#00FF00'>Dust 1</font> <font color='#00FFFF'>açılacaktır.</font>");
			}
			else if(StrContains(secilenMap, "mirage", false) != -1)
			{
				ServerCommand("mp_timelimit 0");
			...
			else if(StrContains(secilenMap, "italy", false) != -1)
			{
				ServerCommand("mp_timelimit 0");
				ServerCommand("mp_maxrounds 0");
				ServerCommand("sm_drkmap cs_italy");
				PrintToChatAll(" \x02[DrK # GaminG] \x10Oylamaların sonucuna göre el sonunda\x04 Italy \x10açılacaktır.");
				PrintToChatAll(" \x05DrK # GaminG , iyi oyunlar diler..");
				PrintCenterTextAll("<font color='#FF0000'>[DrK # GaminG]</font> <font color='#00FFFF'>El sonu</font>\n<font color='#00FF00'>Italy</font> <font color='#00FFFF'>açılacaktır.</font>");
			}
		}
		if (param1 == 1)
		{
