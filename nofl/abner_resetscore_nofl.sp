...
public Action MSG(Handle timer, any client)
{
	if(IsValidClient(client))
		CPrintToChat(client, "\x02[ ☜ NoFL ☞ ] \x01%t", "Restored");
}
...
{                        
	...
	{
		CPrintToChat(client, "\x02[ ☜ NoFL ☞ ] \x01%t", "Plugin Disabled");
	...
	if(GetClientDeaths(client) == 0 && GetClientFrags(client) == 0 && CS_GetMVPCount(client) == 0)
	{
		...
		{
			CPrintToChat(client, "\x02[ ☜ NoFL ☞ ] \x01%t", "Score 0");
			return Plugin_Continue;
		}
	}
	...
	{
		CPrintToChat(client, "\x02[ ☜ NoFL ☞ ] \x01%t", "No Money", cost);
		return Plugin_Continue;
	}
	...
	if(GetConVarInt(hPublic) == 1)
	{
		...
		{
			CPrintToChatAll("\x02[ ☜ NoFL ☞ ] \x01%t", "Player Reset Red", name);
		}
		else if(GetClientTeam(client) == 3)
		{
			CPrintToChatAll("\x02[ ☜ NoFL ☞ ] \x01%t", "Player Reset Blue", name);
		}
		else
		{
			CPrintToChatAll("\x02[ ☜ NoFL ☞ ] \x01%t", "Player Reset Normal", name);
		}
	}
	else
	{
		CPrintToChat(client, "\x02[ ☜ NoFL ☞ ] \x01%t", "You Reset");
	}
	return Plugin_Continue;
}
...
{                           
	...
	if (args != 1)
	{
		ReplyToCommand(client, "\x01[ ☜ NoFL ☞ ] sm_resetplayer <name or #userid>");
		return Plugin_Continue;
	}
	...
	ShowActivity2(client, "[ ☜ NoFL ☞ ] ", "%t", "Reset Score of", target_name);
	return Plugin_Continue;
}
...
{                           
	...
	if (args != 4)
	{
		ReplyToCommand(client, "\x01[ ☜ NoFL ☞ ] sm_setscore <name or #userid> <Kills> <Deaths><Stars>");
		return Plugin_Continue;
	}
	...
	ShowActivity2(client, "[ ☜ NoFL ☞ ] ", "%t", "Set Score", target_name);
	return Plugin_Continue;
}
...
{                           
  	if (args != 6)
	{
		ReplyToCommand(client, "\x01[ ☜ NoFL ☞ ] sm_setscore <name or #userid> <Kills> <Deaths><Assists><Stars><Points>");
		return Plugin_Continue;
	}
...
{                           
	...
	if (args != 2)
	{
		ReplyToCommand(client, "\x01[ ☜ NoFL ☞ ] sm_setpoints <name or #userid> <points>");
		return Plugin_Continue;
	}
	...
	ShowActivity2(client, "[ ☜ NoFL ☞ ] ", "%t", "Set Points of", target_name, points);
	return Plugin_Continue;
}
...
{                           
	...
	if (args != 2)
	{
		ReplyToCommand(client, "\x01[ ☜ NoFL ☞ ] sm_setassists <name or #userid> <assists>");
		return Plugin_Continue;
	}
	...
	ShowActivity2(client, "[ ☜ NoFL ☞ ] ", "%t", "Set Assists of", target_name, assists);
	return Plugin_Continue;
}
...
{                           
	...
	if (args != 2)
	{
		ReplyToCommand(client, "\x01[ ☜ NoFL ☞ ] sm_setstars <name or #userid> <stars>");
		return Plugin_Continue;
	}
	...
	ShowActivity2(client, "[ ☜ NoFL ☞ ] ", "%t", "Set Stars of", target_name, stars);
	return Plugin_Continue;
}
