			...
			if(IsClientInGame(i) && IsClientConnected(i) && IsPlayerAlive(i))
			{
				new String:clantagid[32];
				{
					if (IsClientConnected(i) && IsClientInGame(i) && !IsFakeClient(i))
					{
						...
						if(StrEqual(clantagid, "24577568") == true)
						{
							new iPara = 1000;
							PrintToChat(i, " \x02[NoFL Pro Public] \x0CNoFL Pro # \x09Clan tagı kullandığınız için \x0E1.000$ \x09kazandınız.");
						...
						{
							PrintToChat(i, " \x02[NoFL Pro Public] \x0CNoFL Pro # \x09Clan tagı kullanırsanız, her el \x0Efazladan 1.000$ \x09kazanırsınız.");
							PrintToChat(i, " \x04!grup \x06Yazarak grup sayfasını görebilirsiniz.");
							PrintToChat(i, " \x06Gruba girdikten konsola \n\x02cl_clanid 24577568\x06 yazarak kullanabilirsiniz.");
...
{
	PrintHintTextToAll("<font color='#FF0000'>NoFL Pro # </font><font color='#00FF00'>tagı alarak her el fazladan </font><font color='#FF00FF'>1.000$</font> <font color='#00FFFF'>kazanabilirsiniz</font>");
}
