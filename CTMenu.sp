...
public Action:TRCT(client,args)
{
	...
	{
		CPrintToChat(client, " \x02[DrK # GaminG] \x04Bu komut sadece KOMUTÇU'lar içindir.");
		return;
	}
}
...
public Action:CTMenu(clientId) 
{
	...
	SetMenuTitle(menu, "DrK # GaminG CTMenu");
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : CT'ye GOD verildi.",isim);
		...
		{
			{
				...
				for (int i = 1; i <= MaxClients; i++) 
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						SDKUnhook(i, SDKHook_Touch, OnTouch);
						SetEntPropFloat(i, Prop_Data, "m_flLaggedMovementValue", 1.0);
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Tüm ayarlar sıfırlandı.",isim); 
						SDKUnhook(i, SDKHook_SetTransmit, Hook_SetTransmit);
						new can = (GetClientHealth(i), 100);
						SetEntityHealth(i, can);
						SetEntityRenderColor(i, 255, 255, 255, 255);
...
public Action:OyunMenu(clientId) 
{
	...
	SetMenuTitle(menu, "DrK # GaminG OyunMenu");
	decl String:opcionmenu[124];
...
public OMenuDevam(Handle:menu, MenuAction:action, client, itemNum)
{
	...
	if ( action == MenuAction_Select ) 
	{
		...
		{
			{
				...
				{ 
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						...
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Kuş Avı Açıldı.",isim);
					}
				}
			}
		}
		...
		{
			{
				...
				{ 
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						...
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : KamiKZ Oyunu Açıldı.",isim);
					}
				}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Aref Oyunu Açıldı.",isim);
						if(GetClientTeam(i) == 3)
						{
							new can = (GetClientHealth(i), 25000);
							SetEntityHealth(i, can);
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Bombacı Mülayim Oyunu Açıldı.",isim);
						if(GetClientTeam(i) == 3)
						{
							new can = (GetClientHealth(i), 25000);
							SetEntityHealth(i, can);	
		...
		{
			{
				for (int i = 1; i <= MaxClients; i++)
				{
					ServerCommand("sv_infinite_ammo 1");
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Körebe Oyunu Açıldı.",isim);
						if(GetClientTeam(i) == 3)
						{
							SDKHook(i, SDKHook_SetTransmit, Hook_SetTransmit);
		...
		{
			{
				CPrintToChatAll(" \x02[DrK # GaminG] \x04%s : Yakala Mod Açıldı.",isim);
				for (int i = 1; i <= MaxClients; i++)
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						if(GetClientTeam(i) == 3)
		...
		else if ( strcmp(info,"option10") == 0 ) 
		{
			{
				Catismash(client);
				CPrintToChatAll(" \x02[DrK # GaminG] \x04%s : Çatışma Oyunu Açıldı.",isim);
				for (int i = 1; i <= MaxClients; i++)
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						ZombiSilah2(i)
		...
		{
			{
				for (int i = 1; i <= MaxClients; i++)
				{
					ServerCommand("sv_infinite_ammo 1");
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Zombi Mod AKTİF GADRIYANLAR'a 5000HP Verildi.",isim);
						if(GetClientTeam(i) == 3)
						{
							SetEntityRenderColor(i, 255, 0, 0, 255);
		...
		{
			{
				for (int i = 1; i <= MaxClients; i++)
				{
					ServerCommand("sv_infinite_ammo 1");
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Zombi Mod AKTİF GADRIYANLAR'a 6000HP Verildi.",isim);
						if(GetClientTeam(i) == 3)
						{
							SetEntityRenderColor(i, 255, 0, 0, 255);
		...
		{
			{
				for (int i = 1; i <= MaxClients; i++)
				{
					ServerCommand("sv_infinite_ammo 1");
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Zombi Mod AKTİF GADRIYANLAR'a 7000HP Verildi.",isim);
						if(GetClientTeam(i) == 3)
						{
							SetEntityRenderColor(i, 255, 0, 0, 255);
		...
		{
			{
				for (int i = 1; i <= MaxClients; i++)
				{
					ServerCommand("sv_infinite_ammo 1");
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Zombi Mod AKTİF GADRIYANLAR'a 8000HP Verildi.",isim);
						if(GetClientTeam(i) == 3)
						{
							SetEntityRenderColor(i, 255, 0, 0, 255);
		...
		{
			{
				for (int i = 1; i <= MaxClients; i++)
				{
					ServerCommand("sv_infinite_ammo 1");
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Zombi Mod AKTİF GADRIYANLAR'a 9000HP Verildi.",isim);
						if(GetClientTeam(i) == 3)
						{
							SetEntityRenderColor(i, 255, 0, 0, 255);
		...
		{
			{
				for (int i = 1; i <= MaxClients; i++)
				{
					ServerCommand("sv_infinite_ammo 1");
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Zombi Mod AKTİF GADRIYANLAR'a 10000HP Verildi.",isim);
						if(GetClientTeam(i) == 3)
						{
							SetEntityRenderColor(i, 255, 0, 0, 255);
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : M4A4 FF Açıldı.",isim);
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : M4A1-S FF Açıldı.",isim);
						if(GetClientTeam(i) == 2)
						{
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : AK47 FF Açıldı.",isim);
						if(GetClientTeam(i) == 2)
						{
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : AWP FF Açıldı.",isim);
						if(GetClientTeam(i) == 2)
						{
							GivePlayerItem(i, "weapon_awp");
							Client_GiveWeaponAndAmmo(i, "weapon_awp", _, 0, _, 30);
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : DEAGLE FF Açıldı.",isim);
						if(GetClientTeam(i) == 2)
						{
							GivePlayerItem(i, "weapon_deagle");
							Client_GiveWeaponAndAmmo(i, "weapon_deagle", _, 0, _, 30);
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : NOVA FF Açıldı.",isim);
						if(GetClientTeam(i) == 2)
						{
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : BIZON FF Açıldı.",isim);
						if(GetClientTeam(i) == 2)
						{
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : ZEUS FF Açıldı.",isim);
						if(GetClientTeam(i) == 2)
						{
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Dost Ateşi Açıldı.",isim);
					}
				}
			}
		}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Dost Ateşi Kapatıldı.",isim);
					}
				}
			}
		}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Semiclip Açıldı.",isim);
					}
				}
			}
		}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Semiclip Kapatıldı.",isim);
					}
				}
			}
		}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Mahkumlar Donduruldu.",isim);
					}
				}
			}
		}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Mahkum Dondurulmasi Kaldirildi.",isim);
					}
				}
			}
		}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Mahkumlarin Silahlari Alindi.",isim);
					}
				}
			}
		}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Mahkumlar Cekildi.",isim);
					}
				}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Sınırsız Mermi Açıldı.",isim);
					}
				}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Sınırsız Mermi Kapatıldı.",isim);
					}
				}
			}
		}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Ölü Olan Tüm Mahkumlar Revlendi.",isim);
...
public MenuHandler_Players(Handle:menu, MenuAction:action, param1, param2)
{
	...
	else if (action == MenuAction_Cancel)
	{
		...
		CPrintToChat(param1, " \x02[DrK # GaminG]\x04 Ölü Oyuncu Yok !");
	...
	else if (action == MenuAction_Select)
	{
		...
		{
			CPrintToChat(param1, " \x02[DrK # GaminG] %t", "Mevcut Oyuncu Bulunamadi.");
		}
		else if (!CanUserTarget(param1, target))
		{
			...
			{
				if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
					CPrintToChat(i," \x02[DrK # GaminG] %s : \x04%s isimli oyuncu revlendi.",isim, name);
				}
			}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Gardiyanlara Kirmizi Glow Açıldı.",isim);
						if(GetClientTeam(i) == 3)
						{
							SetEntityRenderColor(i, 255, 0, 0, 255);	
						}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Gardiyanlara Mavi Glow Açıldı.",isim);
						if(GetClientTeam(i) == 3)
						{
							SetEntityRenderColor(i, 0, 0, 255, 255);	
						}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Gardiyanlara Yesil Glow Açıldı.",isim);
						if(GetClientTeam(i) == 3)
						{
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Gardiyanlara Sari Glow Açıldı.",isim);
						if(GetClientTeam(i) == 3)
						{
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Gardiyanlara Turkuaz Glow Açıldı.",isim);
						if(GetClientTeam(i) == 3)
						{
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Mahkumlara Kirmizi Glow Açıldı.",isim);
						if(GetClientTeam(i) == 2)
						{
							SetEntityRenderColor(i, 255, 0, 0, 255);	
						}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Mahkumlara Mavi Glow Açıldı.",isim);
						if(GetClientTeam(i) == 2)
						{
							SetEntityRenderColor(i, 0, 0, 255, 255);	
						}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Mahkumlara Yesil Glow Açıldı.",isim);
						if(GetClientTeam(i) == 2)
						{
							SetEntityRenderColor(i, 0, 128, 0, 255);	
						}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Mahkumlara Sari Glow Açıldı.",isim);
						if(GetClientTeam(i) == 2)
						{
							SetEntityRenderColor(i, 255, 255, 0, 255);	
						}
		...
		{
			{
				...
				{
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Mahkumlara Turkuaz Glow Açıldı.",isim);
						if(GetClientTeam(i) == 2)
						{
							SetEntityRenderColor(i, 0, 255, 255, 255);	
						}
...
public Action:Countdown(Handle timer)
{
	...
	if(timeleft <= 10)
		PrintToChatAll(" \x02[DrK # GaminG] \x10FF \x04%i \x10saniye sonra açılacak!", timeleft);
	if(timeleft == 0)
	{
		PrintToChatAll(" \x02[DrK # GaminG] \x04FF açılmıştır, Bol Şans!");
		...
		{
			{
				for (int i = 1; i <= MaxClients; i++)
				{
					ServerCommand("sv_infinite_ammo 1");
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Çatışma AKTİF GADRIYANLAR'a 300HP Verildi.",isim);
						if(GetClientTeam(i) == 3)
						{
							new can = (GetClientHealth(i) , 300);
							SetEntityHealth(i, can);
		...
		{
			{
				for (int i = 1; i <= MaxClients; i++)
				{
					ServerCommand("sv_infinite_ammo 1");
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Çatışma AKTİF GADRIYANLAR'a 500HP Verildi.",isim);
						if(GetClientTeam(i) == 3)
						{
							new can = (GetClientHealth(i) , 500);
							SetEntityHealth(i, can);
		...
		{
			{
				for (int i = 1; i <= MaxClients; i++)
				{
					ServerCommand("sv_infinite_ammo 1");
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Çatışma AKTİF GADRIYANLAR'a 700HP Verildi.",isim);
						if(GetClientTeam(i) == 3)
						{
		...
		{
			{
				for (int i = 1; i <= MaxClients; i++)
				{
					ServerCommand("sv_infinite_ammo 1");
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Çatışma AKTİF GADRIYANLAR'a 1000HP Verildi.",isim);
						if(GetClientTeam(i) == 3)
						{
		...
		{
			{
				for (int i = 1; i <= MaxClients; i++)
				{
					ServerCommand("sv_infinite_ammo 1");
					if(i && IsClientInGame(i) && IsClientConnected(i) && !IsFakeClient(i))   {
						CPrintToChat(i," \x02[DrK # GaminG] \x04%s : Çatışma AKTİF GADRIYANLAR'a 2000HP Verildi.",isim);
						if(GetClientTeam(i) == 3)
						{
