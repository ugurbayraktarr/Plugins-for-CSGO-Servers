...
CrearArbol(client, String:cookie1[100], String:cookie2[100])
{
	...
	SetTrieValue(arbol[client], "weapon_revolver", StringToInt(parte1[23]));
	
	
	
	decl String:parte2[20][4];
	...
	SetTrieValue(arbol[client], "weapon_knife_falchion", StringToInt(parte2[17]));
	SetTrieValue(arbol[client], "weapon_knife_push", StringToInt(parte2[17]));
	SetTrieValue(arbol[client], "weapon_knife_survival_bowie", StringToInt(parte2[18]));
...
SaveCookies(client)
{
	...
	GetTrieValue(arbol[client], "weapon_revolver", valor);
	Format(cookie1, sizeof(cookie1), "%s;%i", cookie1, valor);
	...
	GetTrieValue(arbol[client], "weapon_knife_falchion", valor);
	Format(cookie2, sizeof(cookie2), "%s;%i", cookie2, valor);
	
	GetTrieValue(arbol[client], "weapon_knife_push", valor);
	Format(cookie2, sizeof(cookie2), "%s;%i", cookie2, valor);
	
	GetTrieValue(arbol[client], "weapon_knife_survival_bowie", valor);
	Format(cookie2, sizeof(cookie2), "%s;%i", cookie2, valor);
