			...
			if(IsClientInGame(i) && IsClientConnected(i) && IsPlayerAlive(i))
			{
				new String:clantagid[32];
				{
					if (IsClientConnected(i) && IsClientInGame(i) && !IsFakeClient(i))
					{
						...
						if(StrEqual(clantagid, "26703933") == true)
						{
							new iPara = 1000;
							PrintToChat(i, " \x02[NarkozCS] \x0CNarkozCS # \x09Clan tagı kullandığınız için \x0E1.000$ \x09kazandınız.");
						...
						{
							PrintToChat(i, " \x02[NarkozCS] \x0CNarkozCS # \x09Clan tagı kullanırsanız, her el \x0Efazladan 1.000$ \x09kazanırsınız.");
							PrintToChat(i, " \x04!grup \x06Yazarak grup sayfasını görebilirsiniz.");
							PrintToChat(i, " \x06Gruba girdikten konsola \n\x02cl_clanid 26703933\x06 yazarak kullanabilirsiniz.");
...
{
	PrintHintTextToAll("<font color='#FF0000'>NarkozCS # </font><font color='#00FF00'>tagı alarak her el fazladan </font><font color='#FF00FF'>1.000$</font> <font color='#00FFFF'>kazanabilirsiniz</font>");
}
