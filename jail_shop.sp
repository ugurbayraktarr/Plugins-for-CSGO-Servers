...
public OnPluginStart()
{
	...
	RegConsoleCmd("sm_isyanmenu", SHOPMENU);
	RegConsoleCmd("sm_isyankredi", Creditos);
	RegConsoleCmd("sm_hediyekredi", Command_SendCredits);
	RegConsoleCmd("sm_reviver", Reviver);
	RegConsoleCmd("sm_vercreditos", Command_ShowCredits);
	
	RegAdminCmd("sm_krediver", SetCreditos, ADMFLAG_ROOT);
	RegAdminCmd("sm_kredibelirle", SetCreditos2, ADMFLAG_ROOT);
	// ======================================================================
